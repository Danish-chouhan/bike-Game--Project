...
const btnLeft = createAndAppend("button","class","left",btnContainerOfHandel,"click")
const btnRight = createAndAppend("button","class","right",btnContainerOfHandel,"click")


// controller
const btnContainerOfController = createAndAppend("div","class","buttonContainerController",controler)
const btnBreak = createAndAppend("button","class","break",btnContainerOfController,"click")
const btnAccelerator = createAndAppend("button","class","accelerator",btnContainerOfController,"click")
